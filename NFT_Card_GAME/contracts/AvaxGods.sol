...
contract AVAXGods is ERC1155, Ownable, ERC1155Supply {
    ...
    struct Player {
        ...
        uint256 playerMana; /// @param playerMana 法力值 player mana; affected by battle results
        uint256 playerHealth; /// @param playerHealth 生命值 player health; affected by battle results
        bool inBattle; /// @param 是否为战斗状态 inBattle boolean to indicate if a player is in battle
    }
    ...
    function registerPlayer(
        ...
        createRandomGameToken(_gameTokenName); // 创建随机的游戏代币
