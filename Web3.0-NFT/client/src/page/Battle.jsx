...
import { Alert, Card, ActionButton, PlayerInfo, GameInfo } from "../components"
...
const Battle = () => {
    ...
    const [player1, setPlayer01] = useState({})
    const [player2, setPlayer02] = useState({})
    // 战斗名字
