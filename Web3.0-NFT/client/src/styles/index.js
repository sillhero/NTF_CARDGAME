const styles = {
  // general
  headText: 'font-rajdhani font-bold text-white sm:text-6xl text-4xl font-style:STXinwei',
  ...
  // infoText 但是文字要是白色
  infoTextWhite: 'font-rajdhani font-medium text-lg text-white cursor-pointer',
  ...
  label: 'font-rajdhani font-semibold text-2xl text-white mb-3 display-block',
